...
<?php
	...
	if (isset($_POST['submit'])) {
		check_admin_referer( 'classdex_edit_class','classdex_edit_class_nonce' );
...
?>
<form action="admin.php?page=classdex_edit_class&amp;class_id=<?php echo urlencode($class['class_id']); ?>" method="post">
	<?php wp_nonce_field( 'classdex_edit_class','classdex_edit_class_nonce' );  ?>
	<?php 
		$edit = true;
	...
	<div class="form-actions">
	  ...
	  <a href="admin.php?page=classdex_edit_class&amp;class_id=<?php echo urlencode($class['class_id']); ?>" class="btn">Cancel</a>
...
<div id="deleteClass" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-footer">
  	<?php $form_action_url = "admin.php?page=classdex_delete_table_item&amp;noheader=true&amp;t=classes&amp;i=" . urlencode($class['class_id']); ?>	
