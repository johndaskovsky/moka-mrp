...
<?php 
	...
	echo ")"; 
?>
&nbsp; <a class="btn" href="admin.php?page=mokamrp_edit_customer&amp;cust_id=<?php echo $customer['cust_id']; ?>"><i class="icon-pencil"></i> Edit</a></h2>
<?php
	...
	echo "<form class=\"form-inline\" action=\"admin.php?page=mokamrp_full_payment&amp;noheader=true&amp;cust_id=" . urlencode($customer['cust_id']) . "\" method=\"post\">";
	wp_nonce_field( 'mokamrp_full_payment','mokamrp_full_payment_nonce' );
?>
<?php
	...
	if($total_payment !== NULL){
		...
		echo "&nbsp;&nbsp;&nbsp;</h3>
				...
				&nbsp;&nbsp;&nbsp;
				  ...
				  <a href=\"admin.php?page=mokamrp_partial_payment&amp;cust_id={$customer['cust_id']}\" class=\"btn pull-right\">Partial Payment</a>
				</div>
			</form>";
	}
?>
