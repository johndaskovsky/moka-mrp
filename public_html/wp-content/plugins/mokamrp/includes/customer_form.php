	<div class="row-fluid">
  		<div class="span5">
			...
			<label class="checkbox inline">
				<input type="checkbox" name="member" value="1" id="member" <?php if($edit){if($customer['member'] == 1) { echo "checked"; }} ?> > Member (<?php echo esc_attr( get_option('mokamrp_discount_member') ); ?>% off)
			</label>	
			<label class="checkbox inline">
				<input type="checkbox" name="senior" value="1" id="senior" <?php if($edit){if($customer['senior'] == 1) { echo "checked"; }} ?> > Senior (<?php echo esc_attr( get_option('mokamrp_discount_senior') ); ?>% off)
			</label>
			<label class="checkbox inline">
				<input type="checkbox" name="student" value="1" id="student" <?php if($edit){if($customer['student'] == 1) { echo "checked"; }} ?> > Student (<?php echo esc_attr( get_option('mokamrp_discount_student') ); ?>% off)
			</label>
			<br><br>
