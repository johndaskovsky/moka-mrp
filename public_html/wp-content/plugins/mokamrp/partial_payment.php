...
<?php
	...
	if ( isset($_POST['submit']) && ( !empty($_POST['partial_pays']) || !empty($_POST['paid_reg_ids']) ) ) {
		check_admin_referer( 'mokamrp_partial_payment','mokamrp_partial_payment_nonce' );	
...
<?php
	...
	echo "<form class=\"form-inline\" action=\"admin.php?page=mokamrp_partial_payment&amp;m=2&amp;cust_id=" . urlencode($customer['cust_id']). "\" method=\"post\">";
	wp_nonce_field( 'mokamrp_partial_payment','mokamrp_partial_payment_nonce' );
?>
<?php
